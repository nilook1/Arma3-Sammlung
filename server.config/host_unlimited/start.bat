...
cd gameserver
arma3server_x64.exe "-profiles=%profilespath%" -name=Administrator -port=%gport% -config=%cd%\server2.cfg -world=empty "-mod=@CBA_A3;@ace;@ACEX;@CUP Terrains - Core;@CUP Terrains - Maps;@CUP Units;@CUP Vehicles;@CUP Weapons;@Advanced Rappelling;@Advanced Urban Rappelling;@Advanced Sling Loading;@Advanced Towing"
